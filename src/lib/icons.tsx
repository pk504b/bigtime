...
export const StopwatchIcon = () => (
  ...
  >
    <g fill="none">
      ...
      <path
        fill="currentColor"
        d="M12 2c.937 0 1.85.108 2.726.311a1 1 0 1 1-.452 1.948a10 10 0 0 0-1.499-.23l-.074-.002a8.95 8.95 0 0 1 4.341 1.517l.606-.606a1 1 0 1 1 1.415 1.414l-.495.495a9 9 0 1 1-7.16-2.827l-.136.006a10 10 0 0 0-1.546.233a1 1 0 0 1-.452-1.948C10.15 2.108 11.064 2 12 2m0 4a7 7 0 1 0 0 14a7 7 0 0 0 0-14m0 2a1 1 0 0 1 .993.883L13 9v4a1 1 0 0 1-1.993.117L11 13V9a1 1 0 0 1 1-1"
      ></path>
    </g>
  </svg>
);
...
export const PauseIcon = ({ size = 24 }) => (
  ...
  >
    <g fill="none">
      ...
      <path
        fill="currentColor"
        d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2m-2 6a1 1 0 0 0-.993.883L9 9v6a1 1 0 0 0 1.993.117L11 15V9a1 1 0 0 0-1-1m4 0a1 1 0 0 0-1 1v6a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1"
      ></path>
    </g>
  </svg>
);
...
// ic:round-plus-one
export const PlusOneIcon = ({ size = 24 }) => (
...
export const ResetIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
export const TimestampIcon = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
